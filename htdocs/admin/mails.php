...
if ($action == 'edit') {
	...
	*/
	...
	print '<tr class="oddeven"><td>'.$langs->trans("MAIN_MAIL_WITH_TO_SELECTED_CONTACT_CUSTOMER").'</td><td>'.yn(getDolGlobalString('MAIN_MAIL_WITH_TO_SELECTED_CONTACT_CUSTOMER')).'</td></tr>';
	print '</table>';
	print '</div>';
